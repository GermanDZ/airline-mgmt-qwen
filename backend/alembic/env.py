...
from app.core.config import get_settings  # noqa: F401 — loads .env via pydantic-settings
from app.models.base import Base  # noqa: F401 — registers declarative models
...
def run_migrations_online() -> None:
    """Run migrations online asynchronously."""
